...
public class AmmoUI : MonoBehaviour
{
    ...
    public void OnWeaponSwitched(BaseWeapon newWeapon)
    {
        ...
        UpdateIcon(newWeapon);
    }

    public void UpdateIcon(BaseWeapon newWeapon)
    {
        if (_currentWeaponIcon.color.a == 0)
        {
            Color color = _currentWeaponIcon.color;
        ...
        _secondWeaponIcon.sprite = _currentWeaponIcon.sprite;
        _currentWeaponIcon.sprite = newWeapon.Settings.icon;
    }
